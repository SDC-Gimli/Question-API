...
app.get('/questions', (req, res) => {
  ...
  // let qStr = `select id as question_id, body as question_body, to_timestamp(date_written/1000) as question_date,asker_name, helpful as question_helpfullness, reported from questions where product_id = ${product_id} order by question_helpfullness desc`;
