...
app.get('/questions', async (req, res) => {
  ...
  response.results = await db.query(`select id as question_id, body as question_body, to_timestamp(date_written/1000) as question_date,asker_name, helpful as question_helpfullness, reported from questions where product_id = ${product_id} order by question_helpfullness desc`).catch(err => console.log(err))
